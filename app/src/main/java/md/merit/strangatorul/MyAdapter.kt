...
class MyAdapter(context: Context, private val exampleList:ArrayList<ExampleItem>) : RecyclerView.Adapter<MyAdapter.MyViewHolder>() {
            ...
            var alertDialog = AlertDialog.Builder(context)
                ...
                .setPositiveButton("Yes", DialogInterface.OnClickListener { dialog, which ->
                    if (MainActivity.dbHandler.deleteTransaction(curentItem.itemNumber))
                    {
                        ...
                        Toast.makeText(context, "Transaction $itemName deleted", Toast.LENGTH_SHORT).show()
                    } else
